                ...
                <div id="first-screen">
                    <div class="window">
                        ...
                        <form id="form" class="font-PT-Sans">
                            <div class="form-item">
                                <label for="email">
                                    <input id="email" class="form-input" name="email" type="email" placeholder="Ваш e-mail" required>
                                </label>
                            </div>
                            <div class="form-item">
                                <label for="password">
                                    <input id="password" class="form-input" name="password" type="password" placeholder="Пароль" required>
                                </label>
                            </div>
                            <div>
